...
export default function BlogCard({
  ...
  return (
    <div className="flex flex-col bg-veryLightBlue border-2 border-veryLightPurple shadow-md rounded-lg p-4 break-inside-avoid" onClick={() => setClickOnThreeDots(!clickOnThreeDots)}>
