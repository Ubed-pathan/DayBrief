...
export default function BlogCard({
  ...
  return (
    <div className="flex w-full flex-col bg-veryLightBlue border-2 border-veryLightPurple shadow-md rounded-lg p-4 break-inside-avoid" onClick={() => {if(clickOnThreeDots) setClickOnThreeDots(false)}}>
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-sm text-veryLightPurple">{date}</h1>
        </div>
